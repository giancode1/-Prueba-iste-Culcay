...
export const EditProduct = ({editProduct, setEditProduct, openEditModal, setOpenEditModal}) => {

    const [formData, setFormData] = useState({
        nombre: editProduct.nombre,
        precio: editProduct.precio,
        cantidad_en_stock: editProduct.cantidad_en_stock,
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await fetch('/api/editar-producto?id='+editProduct.id, {
          method: 'PUT',
          headers: {
                ...
                >
                    ...
                    <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <div className="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                            ...
                            <button onClick={()=>setOpenEditModal(false)} type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="defaultEditModal">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="grid gap-4 mb-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input type="text" pattern="[0-9]+(\.[0-9]+)?" min="0" name="precio" id="precio" 
